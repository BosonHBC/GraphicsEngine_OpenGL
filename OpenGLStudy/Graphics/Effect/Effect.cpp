...
bool Effect::BindUniformVariables()
{
	// Assign uniform ID
...
bool Effect::LoadShader(const char* i_shaderName, GLenum i_shaderType)
{
...
std::string Effect::ReadShaderCode(const char* fileName)
{
